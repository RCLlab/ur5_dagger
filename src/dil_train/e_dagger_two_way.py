...
class ENV:
    def __init__(self,run_name,controller,safety):
    ...
    def save_log(self,save_iter):
        ...
        os.chdir(rec_dir)
        write_mat('dagger_tests/Loop/' + self.controller + self.safety+ '/250/'+self.run_name,
...
if __name__ == '__main__':
    ...
    safety = 'NotSafe/'
    print(controller,safety)
    env = ENV(run_name,controller,safety)
    env.choose_model()
    t = time.time()
    env.reset()
    i = 0
